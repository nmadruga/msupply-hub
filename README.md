# mSupply-hub-web-app
Creates an interface for users to view basic data and daily events from mSupply sites. 

## Install
First, clone this repository, then navigate to inside the mSupply-hub-web-app directory in a terminal window. 
